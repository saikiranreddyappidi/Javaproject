...
public class EscapeGoblin {
    ...
    public static void main(String []args){
        ...
        System.out.print("Enter the speed of Human LabPrograms.Boat: ");
        float speed = read.nextFloat();
        Goblin g = new Goblin();
        double G_dist = g.distance(radius,speed);
        Boat b = new Boat();
        double B_dist = b.distance(radius,speed);
        System.out.println("Distance Travelled by LabPrograms.Goblin: "+G_dist);
        System.out.println("Distance Travelled by LabPrograms.Boat(human): "+B_dist);
        double G_time=Time(G_dist,speed);
        System.out.println("Time taken by LabPrograms.Goblin: "+G_time);
        double B_time=Time(B_dist,speed);
        System.out.println("Time taken by LabPrograms.Boat(Human): "+B_time);
